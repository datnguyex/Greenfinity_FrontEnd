            ...
            >
                <div className="w-[100%] flex justify-center items-center gap-[4rem]">
                    ...
                    <div className="flex items-start flex-col justify-center w-[30%]">
                        <h2 className="text-[64px] font-bold font-roboto-condensed uppercase text-[#009383] mb-[15px]">
                            404 ERROR
                        </h2>
                        <div className="text-[#373737] text-[24px] font-roboto-condensed font-medium">
                            We couldn’t connect to this page.
                        </div>
                        <div className="text-[#373737] text-[16px] font-roboto-condensed font-normal text-start">
